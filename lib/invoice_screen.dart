                        ...
                        child: SlideAnimation(
                          ...
                          child: FadeInAnimation(
                            child: ListTile(
                              ...
                              subtitle: Text(
                                '\INR  ${controller.invoiceList[i].price!}',
                              ),
                              trailing: Text(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        trailing: Text(
                            '\INR  ${controller.totalPrice.value.floor()}'),
                      ),
                      ListTile(
                        title: Text(
                          'Tax:',
                      ...
                      ListTile(
                        ...
                        trailing: Countup(
                          begin: 0,
                          end: controller.totalPrice.value + 50 + 36.44,
